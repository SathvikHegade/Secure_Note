...
function setupEventListeners() {
  ...
  els.closeDev.addEventListener('click', () => closeModal(els.devModal));
  els.closeDevBottom.addEventListener('click', () => closeModal(els.devModal));
...
if (localStorage.getItem("theme") === "dark") {
  ...
  themeIcon.src = "https://cdn.jsdelivr.net/npm/heroicons@2.1.1/24/outline/sun.svg";
}
...
themeToggle.addEventListener("click", () => {
  ...
  if (document.body.classList.contains("dark-mode")) {
    ...
    themeIcon.src = "https://cdn.jsdelivr.net/npm/heroicons@2.1.1/24/outline/moon.svg";
  }
});
